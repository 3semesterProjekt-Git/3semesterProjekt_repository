...
{
    #ifdef calibrate_INTERRUPT_INTERRUPT_CALLBACK
        calibrate_Interrupt_InterruptCallback();
    #endif /* calibrate_INTERRUPT_INTERRUPT_CALLBACK */ 
...
void calibrate_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)calibrate__INTC_NUMBER] = address;
}
...
cyisraddress calibrate_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)calibrate__INTC_NUMBER];
}
...
*
*   Note calling calibrate_Start or calibrate_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after calibrate_Start or calibrate_StartEx has been called. 
...
{
    *calibrate_INTC_PRIOR = priority << 5;
}
...
uint8 calibrate_GetPriority(void)
{
    ...
    priority = *calibrate_INTC_PRIOR >> 5;
