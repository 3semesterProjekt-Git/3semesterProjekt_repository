// ======================================================================
// EX 6 standard 20160818_1.v generated from TopDesign.cysch
// 11/07/2019 at 17:02
...
module Mixer_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("9317ead6-1c56-4ef5-a85e-bee41b6e5fb8/b437129f-ba06-497c-a36f-eae99cfcd888"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    cy_annotation_universal_v1_0 Fotodiode (
        .connect({
            Net_73,
            Net_72
        })
    );
    defparam Fotodiode.comp_name = "Diode_v1_0";
    defparam Fotodiode.port_names = "A, K";
    defparam Fotodiode.width = 2;
	...
	wire [0:0] tmpOE__CH_1_net;
	wire [0:0] tmpFB_0__CH_1_net;
	wire [0:0] tmpIO_0__CH_1_net;
	wire [0:0] tmpINTERRUPT_0__CH_1_net;
	electrical [0:0] tmpSIOVREF__CH_1_net;

	cy_psoc3_pins_v1_10
		#(.id("cf16ef8f-aba0-4c7c-8ccd-1dc6f03680a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		CH_1
		 (.oe(tmpOE__CH_1_net),
		  .y({Net_243}),
		  .fb({tmpFB_0__CH_1_net[0:0]}),
		  .io({tmpIO_0__CH_1_net[0:0]}),
		  .siovref(tmpSIOVREF__CH_1_net),
		  .interrupt({tmpINTERRUPT_0__CH_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CH_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("a00d15aa-fa3f-4e71-95bd-bf116432abea"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("90909090909.0909"),
		  .is_direct(0),
    ...
    assign Net_123 = Net_122 & Net_121;
	...
	wire [0:0] tmpOE__Point_net;
	wire [0:0] tmpFB_0__Point_net;
	wire [0:0] tmpIO_0__Point_net;
	wire [0:0] tmpINTERRUPT_0__Point_net;
	electrical [0:0] tmpSIOVREF__Point_net;
	...
	cy_psoc3_pins_v1_10
		...
		Point
		 (.oe(tmpOE__Point_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Point_net[0:0]}),
		  .io({tmpIO_0__Point_net[0:0]}),
		  .siovref(tmpSIOVREF__Point_net),
		  .interrupt({tmpINTERRUPT_0__Point_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Point_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
