...
uint8 NP_Neo_ONTime_initVar = 0u;


/*******************************************************************************
* Function Name: NP_Neo_ONTime_Init
********************************************************************************
*
* Summary:
...
void NP_Neo_ONTime_Init(void) 
{
    ...
    NP_Neo_ONTime_PERIOD_REG = NP_Neo_ONTime_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NP_Neo_ONTime_Enable
********************************************************************************
*
* Summary:
...
void NP_Neo_ONTime_Enable(void) 
{
    ...
    */
    NP_Neo_ONTime_AUX_CONTROL_REG |= NP_Neo_ONTime_COUNTER_START;
...
/*******************************************************************************
* Function Name: NP_Neo_ONTime_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NP_Neo_ONTime_initVar - global variable.
*
* Return:
*  None.
*
...
void NP_Neo_ONTime_Start(void) 
{
    ...
    if(NP_Neo_ONTime_initVar == 0u)
    {
        NP_Neo_ONTime_Init();
        NP_Neo_ONTime_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: NP_Neo_ONTime_Stop
********************************************************************************
*
* Summary:
...
void NP_Neo_ONTime_Stop(void) 
{
    ...
    NP_Neo_ONTime_AUX_CONTROL_REG &= (uint8) ~((uint8) NP_Neo_ONTime_COUNTER_START);
...
/*******************************************************************************
* Function Name: NP_Neo_ONTime_WriteCounter
********************************************************************************
*
* Summary:
...
{
    NP_Neo_ONTime_COUNT_REG = (count & NP_Neo_ONTime_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NP_Neo_ONTime_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(NP_Neo_ONTime_COUNT_REG & NP_Neo_ONTime_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NP_Neo_ONTime_WritePeriod
********************************************************************************
*
* Summary:
...
{
    NP_Neo_ONTime_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NP_Neo_ONTime_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(NP_Neo_ONTime_PERIOD_REG);
}
