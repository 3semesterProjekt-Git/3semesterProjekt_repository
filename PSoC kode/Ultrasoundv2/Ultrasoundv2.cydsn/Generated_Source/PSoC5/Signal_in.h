...
void    Signal_in_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Signal_in_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Signal_in__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Signal_in_SetInterruptMode() function.
     *  @{
     */
        #define Signal_in_INTR_NONE      (uint16)(0x0000u)
        #define Signal_in_INTR_RISING    (uint16)(0x0001u)
        #define Signal_in_INTR_FALLING   (uint16)(0x0002u)
        #define Signal_in_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Signal_in_INTR_MASK      (0x01u) 
#endif /* (Signal_in__INTSTAT) */
...
/* SIO registers */
#if defined(Signal_in__SIO_CFG)
    #define Signal_in_SIO_HYST_EN        (* (reg8 *) Signal_in__SIO_HYST_EN)
    #define Signal_in_SIO_REG_HIFREQ     (* (reg8 *) Signal_in__SIO_REG_HIFREQ)
    #define Signal_in_SIO_CFG            (* (reg8 *) Signal_in__SIO_CFG)
    #define Signal_in_SIO_DIFF           (* (reg8 *) Signal_in__SIO_DIFF)
#endif /* (Signal_in__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Signal_in_0_INTTYPE_REG 		(* (reg8 *) Signal_in__0__INTTYPE)
#endif /* (Signal_in__INTSTAT) */
