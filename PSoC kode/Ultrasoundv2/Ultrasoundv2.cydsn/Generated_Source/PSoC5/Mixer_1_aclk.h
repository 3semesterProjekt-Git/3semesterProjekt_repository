...
#define Mixer_1_aclk_SetDivider(clkDivider)         Mixer_1_aclk_SetDividerRegister(clkDivider, 1u)
#define Mixer_1_aclk_SetDividerValue(clkDivider)    Mixer_1_aclk_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define Mixer_1_aclk_SetPhaseValue(clkPhase)        Mixer_1_aclk_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(Mixer_1_aclk__CFG3) */
