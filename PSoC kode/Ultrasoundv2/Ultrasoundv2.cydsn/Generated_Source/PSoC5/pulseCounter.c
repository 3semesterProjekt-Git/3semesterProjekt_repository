                                   ...
                                   
{
        ...
        pulseCounter_GLOBAL_ENABLE &= ((uint8)(~pulseCounter_BLOCK_EN_MASK));
    #else
        CY_SET_REG16(pulseCounter_COUNTER_LSB_PTR, counter);
    #endif /* (pulseCounter_UsingFixedFunction) */
}
#endif /* (!(pulseCounter_UsingFixedFunction && (CY_PSOC5A))) */
...
uint16 pulseCounter_ReadCounter(void) 
{
    ...
    #if(pulseCounter_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(pulseCounter_STATICCOUNT_LSB_PTR));
    #else
        return (CY_GET_REG16(pulseCounter_STATICCOUNT_LSB_PTR));
    #endif /* (pulseCounter_UsingFixedFunction) */
}
...
void pulseCounter_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(pulseCounter_PERIOD_LSB_PTR, period);
    #endif /* (pulseCounter_UsingFixedFunction) */
}
...
{
    #if(pulseCounter_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(pulseCounter_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(pulseCounter_PERIOD_LSB_PTR));
    #endif /* (pulseCounter_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG16(pulseCounter_COMPARE_LSB_PTR, compare);
    #endif /* (pulseCounter_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG16(pulseCounter_COMPARE_LSB_PTR));
}
