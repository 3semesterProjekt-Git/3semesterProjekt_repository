...
uint8 NP_Neo_BITCNT_initVar = 0u;


/*******************************************************************************
* Function Name: NP_Neo_BITCNT_Init
********************************************************************************
*
* Summary:
...
void NP_Neo_BITCNT_Init(void) 
{
    ...
    NP_Neo_BITCNT_PERIOD_REG = NP_Neo_BITCNT_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NP_Neo_BITCNT_Enable
********************************************************************************
*
* Summary:
...
void NP_Neo_BITCNT_Enable(void) 
{
    ...
    */
    NP_Neo_BITCNT_AUX_CONTROL_REG |= NP_Neo_BITCNT_COUNTER_START;
...
/*******************************************************************************
* Function Name: NP_Neo_BITCNT_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NP_Neo_BITCNT_initVar - global variable.
*
* Return:
*  None.
*
...
void NP_Neo_BITCNT_Start(void) 
{
    ...
    if(NP_Neo_BITCNT_initVar == 0u)
    {
        NP_Neo_BITCNT_Init();
        NP_Neo_BITCNT_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: NP_Neo_BITCNT_Stop
********************************************************************************
*
* Summary:
...
void NP_Neo_BITCNT_Stop(void) 
{
    ...
    NP_Neo_BITCNT_AUX_CONTROL_REG &= (uint8) ~((uint8) NP_Neo_BITCNT_COUNTER_START);
...
/*******************************************************************************
* Function Name: NP_Neo_BITCNT_WriteCounter
********************************************************************************
*
* Summary:
...
{
    NP_Neo_BITCNT_COUNT_REG = (count & NP_Neo_BITCNT_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NP_Neo_BITCNT_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(NP_Neo_BITCNT_COUNT_REG & NP_Neo_BITCNT_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NP_Neo_BITCNT_WritePeriod
********************************************************************************
*
* Summary:
...
{
    NP_Neo_BITCNT_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NP_Neo_BITCNT_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(NP_Neo_BITCNT_PERIOD_REG);
}
