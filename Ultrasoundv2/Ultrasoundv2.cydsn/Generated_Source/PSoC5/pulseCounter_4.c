                                   ...
                                   
{
        ...
        pulseCounter_4_GLOBAL_ENABLE &= ((uint8)(~pulseCounter_4_BLOCK_EN_MASK));
    #else
        CY_SET_REG32(pulseCounter_4_COUNTER_LSB_PTR, counter);
    #endif /* (pulseCounter_4_UsingFixedFunction) */
}
#endif /* (!(pulseCounter_4_UsingFixedFunction && (CY_PSOC5A))) */
...
uint32 pulseCounter_4_ReadCounter(void) 
{
    ...
    #if(pulseCounter_4_UsingFixedFunction)
        return ((uint32)CY_GET_REG16(pulseCounter_4_STATICCOUNT_LSB_PTR));
    #else
        return (CY_GET_REG32(pulseCounter_4_STATICCOUNT_LSB_PTR));
    #endif /* (pulseCounter_4_UsingFixedFunction) */
}
...
void pulseCounter_4_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG32(pulseCounter_4_PERIOD_LSB_PTR, period);
    #endif /* (pulseCounter_4_UsingFixedFunction) */
}
...
{
    #if(pulseCounter_4_UsingFixedFunction)
        return ((uint32)CY_GET_REG16(pulseCounter_4_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG32(pulseCounter_4_PERIOD_LSB_PTR));
    #endif /* (pulseCounter_4_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG32(pulseCounter_4_COMPARE_LSB_PTR, compare);
    #endif /* (pulseCounter_4_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG32(pulseCounter_4_COMPARE_LSB_PTR));
}
