...
#define pulseCounter_2_Resolution            32u
...
#define pulseCounter_2_GetInterruptSource() pulseCounter_2_ReadStatusRegister()
    ...
    void    pulseCounter_2_WriteCounter(uint32 counter) \
            ; 
#endif /* (!(pulseCounter_2_UsingFixedFunction && (CY_PSOC5A))) */
uint32  pulseCounter_2_ReadCounter(void) ;
uint32  pulseCounter_2_ReadCapture(void) ;
void    pulseCounter_2_WritePeriod(uint32 period) \
    ;
uint32  pulseCounter_2_ReadPeriod( void ) ;
#if (!pulseCounter_2_UsingFixedFunction)
    void    pulseCounter_2_WriteCompare(uint32 compare) \
        ;
    uint32  pulseCounter_2_ReadCompare( void ) \
        ;
 ...
 **************************************/
#define pulseCounter_2_CAPTURE_MODE_CONF       1u
#define pulseCounter_2_INIT_PERIOD_VALUE       4294967294u
...
#define pulseCounter_2_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << pulseCounter_2_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)1u << pulseCounter_2_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
...
#define pulseCounter_2_DEFAULT_COMPARE_MODE    1u
    ...
    #define pulseCounter_2_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)1u << pulseCounter_2_CTRL_CAPMODE0_SHIFT))
#else    
    #define pulseCounter_2_DEFAULT_CAPTURE_MODE    (1u )
 ...
 *************************************/
    ...
    #define pulseCounter_2_RT1_PTR             ( (reg8 *) pulseCounter_2_CounterHW__RT1)
        ...
        #define pulseCounter_2_COUNTER_LSB_PTR     ( (reg8 *)\
            ...
            #define pulseCounter_2_STATICCOUNT_LSB     (*(reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_F0_REG )
            #define pulseCounter_2_STATICCOUNT_LSB_PTR ( (reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_F0_REG )
            #define pulseCounter_2_PERIOD_LSB          (*(reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_D0_REG )
            #define pulseCounter_2_PERIOD_LSB_PTR      ( (reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_D0_REG )
            #define pulseCounter_2_COMPARE_LSB         (*(reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_D1_REG )
            #define pulseCounter_2_COMPARE_LSB_PTR     ( (reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_D1_REG )
            #define pulseCounter_2_COUNTER_LSB         (*(reg16 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_A0_REG )  
            #define pulseCounter_2_COUNTER_LSB_PTR     ( (reg16 *)\
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
        ...
        #define pulseCounter_2_COUNTER_LSB_PTR     ( (reg32 *)\
            ...
            #define pulseCounter_2_STATICCOUNT_LSB     (*(reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_F0_REG )
            #define pulseCounter_2_STATICCOUNT_LSB_PTR ( (reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_F0_REG )
            #define pulseCounter_2_PERIOD_LSB          (*(reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_D0_REG )
            #define pulseCounter_2_PERIOD_LSB_PTR      ( (reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_D0_REG )
            #define pulseCounter_2_COMPARE_LSB         (*(reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_D1_REG )
            #define pulseCounter_2_COMPARE_LSB_PTR     ( (reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_D1_REG )
            #define pulseCounter_2_COUNTER_LSB         (*(reg32 *) \
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_A0_REG )  
            #define pulseCounter_2_COUNTER_LSB_PTR     ( (reg32 *)\
                pulseCounter_2_CounterUDB_sC32_counterdp_u0__32BIT_A0_REG )
    ...
    #define pulseCounter_2_AUX_CONTROLDP0 \
        (*(reg8 *) pulseCounter_2_CounterUDB_sC32_counterdp_u0__DP_AUX_CTL_REG)
    ...
    #define pulseCounter_2_AUX_CONTROLDP0_PTR \
       ...
       #define pulseCounter_2_AUX_CONTROLDP1 \
           (*(reg8 *) pulseCounter_2_CounterUDB_sC32_counterdp_u1__DP_AUX_CTL_REG)
       ...
       #define pulseCounter_2_AUX_CONTROLDP2 \
           (*(reg8 *) pulseCounter_2_CounterUDB_sC32_counterdp_u2__DP_AUX_CTL_REG)
       ...
       #define pulseCounter_2_AUX_CONTROLDP3 \
           (*(reg8 *) pulseCounter_2_CounterUDB_sC32_counterdp_u3__DP_AUX_CTL_REG)
